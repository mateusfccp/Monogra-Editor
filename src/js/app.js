...
var _user$project$Editor_Models$Model = F2(
	function (a, b) {
		return {active: a, document: b};
	});
var _user$project$Editor_Models$initialModel = A2(_user$project$Editor_Models$Model, '', _krisajenkins$remotedata$RemoteData$Loading);
var _user$project$Editor_Models$Document = F2(
	function (a, b) {
		return {meta: a, structure: b};
	});
var _user$project$Editor_Models$DocumentMeta = F4(
	function (a, b, c, d) {
		return {$abstract: a, authors: b, keywords: c, title: d};
	});
var _user$project$Editor_Models$BlockNode = F3(
	function (a, b, c) {
		return {id: a, value: b, children: c};
	});
var _user$project$Editor_Models$Subsection = function (a) {
	return {ctor: 'Subsection', _0: a};
};
var _user$project$Editor_Models$Section = function (a) {
	return {ctor: 'Section', _0: a};
};
var _user$project$Editor_Models$Root = {ctor: 'Root'};
var _user$project$Editor_Models$Paragraph = F2(
	function (a, b) {
		return {ctor: 'Paragraph', _0: a, _1: b};
	});
var _user$project$Editor_Models$None = {ctor: 'None'};
var _user$project$Editor_Models$Some = function (a) {
	return {ctor: 'Some', _0: a};
};
var _user$project$Editor_Models$Quote = {ctor: 'Quote'};
var _user$project$Editor_Models$DefaultParagraph = {ctor: 'DefaultParagraph'};
var _user$project$Editor_Models$Bibliography = {ctor: 'Bibliography'};
var _user$project$Editor_Models$Body = {ctor: 'Body'};
var _user$project$Editor_Models$Index = {ctor: 'Index'};
var _user$project$Editor_Models$Cover = {ctor: 'Cover'};

var _user$project$BlockTree$get = F2(
	function (tree, id) {
		if (_elm_lang$core$Native_Utils.eq(tree.id, id)) {
			return _elm_lang$core$Maybe$Just(tree.value);
		} else {
			var _p0 = tree.children;
			if (_p0.ctor === 'Some') {
				return _elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filterMap,
						function (element) {
							return A2(_user$project$BlockTree$get, element, id);
						},
						_p0._0));
			} else {
				return _elm_lang$core$Maybe$Nothing;
...
var _user$project$Editor_Blocks_Paragraph$html = function (content) {
	return A2(
...
var _user$project$Editor_Blocks_Section$html = F2(
	function (sectiontype, children) {
		var _p0 = sectiontype;
		switch (_p0.ctor) {
			case 'Cover':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('section cover'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Capa'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Este bloco representa a capa.'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
			...
			case 'Index':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('section index'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Índice'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Aqui será renderizada uma representação do índice.'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
			...
			case 'Body':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('section body'),
						_1: {ctor: '[]'}
					},
					A2(
						_elm_lang$core$Basics_ops['++'],
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Corpo'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
			...
			default:
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('section bibliography'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Bibliografia'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Aqui será renderizada uma representação da bibliografia.'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Editor_Blocks_Subsection$html = F2(
	function (heading, children) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('subsection'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'Seção: ', heading)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$Editor_Blocks_Block$view = function (block) {
	var inner = function () {
		var _p0 = block.value;
		switch (_p0.ctor) {
			case 'Paragraph':
				return _user$project$Editor_Blocks_Paragraph$html(_p0._1);
			case 'Root':
				return A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					_user$project$Editor_Blocks_Block$parseChildren(block.children));
			case 'Section':
				return A2(
					_user$project$Editor_Blocks_Section$html,
					_p0._0,
					_user$project$Editor_Blocks_Block$parseChildren(block.children));
			default:
				return A2(
					_user$project$Editor_Blocks_Subsection$html,
					_p0._0,
					_user$project$Editor_Blocks_Block$parseChildren(block.children));
		}
	}();
...
var _user$project$Editor_Blocks_Block$parseChildren = function (children) {
	var _p1 = children;
	if (_p1.ctor === 'Some') {
		return A2(_elm_lang$core$List$map, _user$project$Editor_Blocks_Block$view, _p1._0);
	} else {
		return {ctor: '[]'};
	}
};
var _user$project$Editor_Blocks_Block$childrenDecoder = function (children) {
	var _p2 = children;
	if (_p2.ctor === 'Nothing') {
		return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$None);
	} else {
		var _p4 = _p2._0;
		var _p3 = _p4;
		if (_p3.ctor === '[]') {
			...
			return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(
				_user$project$Editor_Models$Some(_p4));
		}
	}
};
var _user$project$Editor_Blocks_Block$subsectionDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'SubsectionHeading',
	_elm_lang$core$Json_Decode$string,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$Subsection));
var _user$project$Editor_Blocks_Block$sectionTypeDecoder = function (sectionType) {
	var _p5 = sectionType;
	switch (_p5) {
		case 'Cover':
			return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$Cover);
		case 'Index':
			return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$Index);
		case 'Body':
			return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$Body);
		case 'Bibliography':
			return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$Bibliography);
		default:
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], sectionType, ' is not a recognized SectionType'));
	}
};
var _user$project$Editor_Blocks_Block$sectionDecoder = A2(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
	A2(
		_elm_lang$core$Json_Decode$andThen,
		_user$project$Editor_Blocks_Block$sectionTypeDecoder,
		A2(_elm_lang$core$Json_Decode$field, 'SectionType', _elm_lang$core$Json_Decode$string)),
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$Section));
var _user$project$Editor_Blocks_Block$paragraphTypeDecoder = function (paragraphType) {
	var _p6 = paragraphType;
	switch (_p6) {
		case 'Default':
			return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$DefaultParagraph);
		case 'Quote':
			return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$Quote);
		default:
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], paragraphType, ' is not a recognized ParagraphType'));
	}
};
var _user$project$Editor_Blocks_Block$paragraphDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'ParagraphContent',
	_elm_lang$core$Json_Decode$string,
	A2(
		...
		A2(
			_elm_lang$core$Json_Decode$andThen,
			_user$project$Editor_Blocks_Block$paragraphTypeDecoder,
			A2(_elm_lang$core$Json_Decode$field, 'ParagraphType', _elm_lang$core$Json_Decode$string)),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$Paragraph)));
var _user$project$Editor_Blocks_Block$valueDecoder = function (blockType) {
	var _p7 = blockType;
	switch (_p7) {
		case 'Paragraph':
			return _user$project$Editor_Blocks_Block$paragraphDecoder;
		case 'Root':
			return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$Root);
		case 'Section':
			return _user$project$Editor_Blocks_Block$sectionDecoder;
		case 'Subsection':
			return _user$project$Editor_Blocks_Block$subsectionDecoder;
		default:
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], blockType, ' is not a recognized BlockType'));
	}
};
var _user$project$Editor_Blocks_Block$decoder = A2(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
	A2(
		_elm_lang$core$Json_Decode$andThen,
		_user$project$Editor_Blocks_Block$childrenDecoder,
			...
			A2(
				...
				_elm_lang$core$Json_Decode$list(
					_elm_lang$core$Json_Decode$lazy(
						function (_p8) {
							return _user$project$Editor_Blocks_Block$decoder;
						}))))),
	A2(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
		A2(
			_elm_lang$core$Json_Decode$andThen,
			_user$project$Editor_Blocks_Block$valueDecoder,
			A2(_elm_lang$core$Json_Decode$field, 'Type', _elm_lang$core$Json_Decode$string)),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'id',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$BlockNode))));

var _user$project$Editor_Document$metaDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'title',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			A3(
				...
				'abstract',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$DocumentMeta)))));
var _user$project$Editor_Document$decoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'structure',
	_user$project$Editor_Blocks_Block$decoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'meta',
		_user$project$Editor_Document$metaDecoder,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Models$Document)));
var _user$project$Editor_Document$html = function (structure) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$Editor_Blocks_Block$view(structure),
			_1: {ctor: '[]'}
		});
};

var _user$project$Editor_Messages$SaveDocument = {ctor: 'SaveDocument'};
var _user$project$Editor_Messages$LoadDocument = {ctor: 'LoadDocument'};
var _user$project$Editor_Messages$OnFetchDocument = function (a) {
	return {ctor: 'OnFetchDocument', _0: a};
};

var _user$project$Editor_Commands$fetchDocument = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$Editor_Messages$OnFetchDocument,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, 'http://localhost:4000/api/db', _user$project$Editor_Document$decoder)));

var _user$project$Editor_Subscriptions$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};

var _user$project$Editor_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'OnFetchDocument':
				return {
					ctor: '_Tuple2',
...
var _user$project$Editor_View$failureEditorView = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('editor failure'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('fa fa-exclamation-triangle fa-5x fa-fw'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Could not load your document!'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Editor_View$loadingEditorView = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('editor loading'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('fa fa-cog fa-spin fa-5x fa-fw'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
...
var _user$project$Editor_View$concatAuthors = F2(
	function ($char, list) {
		return A3(
			_elm_lang$core$List$foldr,
			F2(
			...
			'',
			A2(_elm_lang$core$List$intersperse, $char, list));
	});
var _user$project$Editor_View$view = function (model) {
	var _p0 = model.document;
	switch (_p0.ctor) {
		case 'NotAsked':
			return _elm_lang$html$Html$text('There\'s no document!');
		case 'Loading':
			return _user$project$Editor_View$loadingEditorView;
		case 'Success':
			var _p1 = _p0._0;
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], 'Editando ', _p1.meta.title)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
							...
							{ctor: '[]'},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'Autor(es): ',
										A2(_user$project$Editor_View$concatAuthors, ', ', _p1.meta.authors))),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							...
							_1: {
								ctor: '::',
								_0: _user$project$Editor_Document$html(_p1.structure),
								_1: {ctor: '[]'}
							}
						}
					}
		...
		default:
			return _user$project$Editor_View$failureEditorView;
	}
};

var _user$project$Editor$location2messages = function (location) {
	return {ctor: '[]'};
};
var _user$project$Editor$delta2url = F2(
	function (previous, current) {
		return _elm_lang$core$Maybe$Just(
			A2(_rgrempel$elm_route_url$RouteUrl$UrlChange, _rgrempel$elm_route_url$RouteUrl$ModifyEntry, '/'));
	});
var _user$project$Editor$init = {ctor: '_Tuple2', _0: _user$project$Editor_Models$initialModel, _1: _user$project$Editor_Commands$fetchDocument};
var _user$project$Editor$main = _rgrempel$elm_route_url$RouteUrl$program(
	{delta2url: _user$project$Editor$delta2url, location2messages: _user$project$Editor$location2messages, init: _user$project$Editor$init, update: _user$project$Editor_Update$update, view: _user$project$Editor_View$view, subscriptions: _user$project$Editor_Subscriptions$subscriptions})();

var Elm = {};
Elm['BlockTree'] = Elm['BlockTree'] || {};
if (typeof _user$project$BlockTree$main !== 'undefined') {
    _user$project$BlockTree$main(Elm['BlockTree'], 'BlockTree', undefined);
}
...
Elm['Editor'] = Elm['Editor'] || {};
Elm['Editor']['Blocks'] = Elm['Editor']['Blocks'] || {};
Elm['Editor']['Blocks']['Block'] = Elm['Editor']['Blocks']['Block'] || {};
if (typeof _user$project$Editor_Blocks_Block$main !== 'undefined') {
    _user$project$Editor_Blocks_Block$main(Elm['Editor']['Blocks']['Block'], 'Editor.Blocks.Block', undefined);
}
Elm['Editor'] = Elm['Editor'] || {};
Elm['Editor']['Blocks'] = Elm['Editor']['Blocks'] || {};
Elm['Editor']['Blocks']['Paragraph'] = Elm['Editor']['Blocks']['Paragraph'] || {};
if (typeof _user$project$Editor_Blocks_Paragraph$main !== 'undefined') {
    _user$project$Editor_Blocks_Paragraph$main(Elm['Editor']['Blocks']['Paragraph'], 'Editor.Blocks.Paragraph', undefined);
}
Elm['Editor'] = Elm['Editor'] || {};
Elm['Editor']['Blocks'] = Elm['Editor']['Blocks'] || {};
Elm['Editor']['Blocks']['Section'] = Elm['Editor']['Blocks']['Section'] || {};
if (typeof _user$project$Editor_Blocks_Section$main !== 'undefined') {
    _user$project$Editor_Blocks_Section$main(Elm['Editor']['Blocks']['Section'], 'Editor.Blocks.Section', undefined);
}
Elm['Editor'] = Elm['Editor'] || {};
Elm['Editor']['Blocks'] = Elm['Editor']['Blocks'] || {};
Elm['Editor']['Blocks']['Subsection'] = Elm['Editor']['Blocks']['Subsection'] || {};
if (typeof _user$project$Editor_Blocks_Subsection$main !== 'undefined') {
    _user$project$Editor_Blocks_Subsection$main(Elm['Editor']['Blocks']['Subsection'], 'Editor.Blocks.Subsection', undefined);
}
Elm['Editor'] = Elm['Editor'] || {};
Elm['Editor']['Commands'] = Elm['Editor']['Commands'] || {};
if (typeof _user$project$Editor_Commands$main !== 'undefined') {
    _user$project$Editor_Commands$main(Elm['Editor']['Commands'], 'Editor.Commands', undefined);
}
Elm['Editor'] = Elm['Editor'] || {};
Elm['Editor']['Document'] = Elm['Editor']['Document'] || {};
if (typeof _user$project$Editor_Document$main !== 'undefined') {
    _user$project$Editor_Document$main(Elm['Editor']['Document'], 'Editor.Document', undefined);
}
Elm['Editor'] = Elm['Editor'] || {};
Elm['Editor']['Messages'] = Elm['Editor']['Messages'] || {};
if (typeof _user$project$Editor_Messages$main !== 'undefined') {
    _user$project$Editor_Messages$main(Elm['Editor']['Messages'], 'Editor.Messages', undefined);
}
Elm['Editor'] = Elm['Editor'] || {};
Elm['Editor']['Models'] = Elm['Editor']['Models'] || {};
if (typeof _user$project$Editor_Models$main !== 'undefined') {
    _user$project$Editor_Models$main(Elm['Editor']['Models'], 'Editor.Models', undefined);
}
Elm['Editor'] = Elm['Editor'] || {};
Elm['Editor']['Subscriptions'] = Elm['Editor']['Subscriptions'] || {};
if (typeof _user$project$Editor_Subscriptions$main !== 'undefined') {
    _user$project$Editor_Subscriptions$main(Elm['Editor']['Subscriptions'], 'Editor.Subscriptions', undefined);
}
Elm['Editor'] = Elm['Editor'] || {};
Elm['Editor']['Update'] = Elm['Editor']['Update'] || {};
if (typeof _user$project$Editor_Update$main !== 'undefined') {
    _user$project$Editor_Update$main(Elm['Editor']['Update'], 'Editor.Update', undefined);
}
Elm['Editor'] = Elm['Editor'] || {};
Elm['Editor']['View'] = Elm['Editor']['View'] || {};
if (typeof _user$project$Editor_View$main !== 'undefined') {
    _user$project$Editor_View$main(Elm['Editor']['View'], 'Editor.View', undefined);
}
